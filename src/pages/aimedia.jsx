...
import { Upload, X, Link as LinkIcon, FileVideo, Image as ImageIcon } from 'lucide-react';
...
function MediaUploadSection() {
  ...
  const handleAnalyze = () => {
    ...
    // Here you would integrate with your AI analysis API
    ...
    <div className="w-full max-w-3xl mx-auto px-3 select-none sm:px-4 lg:px-6 py-4 lg:py-6">
      ...
      <div className="flex justify-between items-center mb-4 pb-3 border-b border-white/60">
        <div className="flex-1 text-center">
          <span className="text-white text-sm sm:text-base lg:text-lg">AI generated</span>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="mt-3">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-white/80 text-xs sm:text-sm">Or paste a URL</span>
                </div>
                <input
                  type="url"
                  value={mediaUrl}
  ...
  return (
    ...
    <main className="relative z-10">
      ...
      <section className="text-center px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <h2 
          ...
          style={{ 
            ...
            backgroundImage: "linear-gradient(180.119deg, rgb(255, 255, 255) 2.5377%, rgb(124, 233, 255) 98.588%)" 
          }}
        >
          AI Media
        </h2>
        
        <p className="text-white text-xs sm:text-sm lg:text-base max-w-3xl mx-auto leading-relaxed" style={{ fontVariationSettings: "'wdth' 100" }}>
          Our AI Media feature analyzes images and videos to detect whether they are AI-generated or manipulated. By combining advanced forensic signals with transparent results, it helps users quickly assess media authenticity and avoid visual misinformation.
        </p>
      </section>
      ...
      <section className="text-center px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-12 mt-6 sm:mt-8 lg:mt-12">
        <h3 className="text-xl sm:text-2xl lg:text-3xl text-white mb-2 sm:mb-3 font-medium" style={{ fontVariationSettings: "'wdth' 100" }}>
          Want to learn more?
        </h3>
        
        <p className="text-white text-sm sm:text-base lg:text-lg mb-4 sm:mb-6" style={{ fontVariationSettings: "'wdth' 100" }}>
          Get in touch with our team or translator today
        </p>
        
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
          <Link to='/contactus'><button className="bg-[#1d5a5e] hover:bg-[#236b70] text-white px-5 sm:px-6 py-2 sm:py-2.5 rounded-full transition-colors text-sm sm:text-base w-full sm:w-auto" style={{ fontVariationSettings: "'wdth' 100" }}>
            Contact us
          </button>
          </Link>
          <Link to='/FakeNewsdetector'>
          <button className="bg-[#1d5a5e] hover:bg-[#236b70] text-white px-5 sm:px-6 py-2 sm:py-2.5 rounded-full transition-colors text-sm sm:text-base w-full sm:w-auto" style={{ fontVariationSettings: "'wdth' 100" }}>
            Try FactiScan Now
          </button>
          </Link>
        </div>
